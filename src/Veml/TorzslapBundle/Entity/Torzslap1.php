...
class Torzslap1
{
    ...
    public function getCharactersCount()
    {
        ...
        $count += mb_strlen($this->getEv(), 'utf8');
        $count += mb_strlen($this->getFoglalkozasaSzab(), 'utf8');
        $count += mb_strlen($this->getFolyoszam(), 'utf8');
        ...
        $count += mb_strlen($this->getHalalKorulmenyei(), 'utf8');
        $count += mb_strlen($this->getHalalOkaIrva(), 'utf8');
        $count += mb_strlen($this->getHalalOkaSzab(), 'utf8');
        $count += mb_strlen($this->getHasab(), 'utf8');
        $count += mb_strlen($this->getHazNeve(), 'utf8');
        ...
        $count += mb_strlen($this->getLap(), 'utf8');
        $count += mb_strlen($this->getMaradtKkEsVagyon(), 'utf8');
        ...
        $count += mb_strlen($this->getOldal(), 'utf8');
        $count += mb_strlen($this->getOszlop(), 'utf8');
        $count += mb_strlen($this->getSorKot(), 'utf8');
        $count += mb_strlen($this->getTovabbiEgykoruAdat(), 'utf8');
        $count += mb_strlen($this->getUtcaTelepulesIrva(), 'utf8');
        $count += mb_strlen($this->getUtcaTelepulesSzab(), 'utf8');
